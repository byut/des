...
A straightforward yet notably efficient implementation of the Data Encryption
...
The code, credited to Matthew Kwan, was obtained from this
...
DES." There is an even faster implementation, enhanced by an impressive 17%,
...
[main.c](https://github.com/byut/des/blob/main/main.c)). To run this, execute
